...
// 主组件，根据消息类型选择适当的子组件
const AgenticFilterSuggestionMessage: React.FC<AgenticFilterSuggestionMessageProps> = ({ message }) => {
    // 检查消息是否为流式消息
        ...
        <div className="message-font">
            <div className="message-title">
                ...
                <span className="text-yellow-400 message-title-text">
                    {message.isStreaming ? getMessage('processingStatus') : getMessage('processingComplete')}({getMessage('agenticFilterContext')})
                </span>
