...
const MarkdownMessage: React.FC<MarkdownMessageProps> = ({ message }) => {
    ...
    const markdownComponents = {
        ...
        th: ({ ...props }: MarkdownComponentProps) => <th className="markdown-th" {...props} />,
        td: ({ ...props }: MarkdownComponentProps) => <td className="markdown-td" {...props} />,
        
        // 文本和段落组件
        p: ({ ...props }: MarkdownComponentProps) => <p className="markdown-paragraph" {...props} />,
        ...
        // 列表相关组件
        ul: ({ ...props }: MarkdownComponentProps) => <ul className="markdown-list markdown-ul" {...props} />,
        ol: ({ ...props }: MarkdownComponentProps) => <ol className="markdown-list markdown-ol" {...props} />,
        li: ({ ...props }: MarkdownComponentProps) => <li className="markdown-list-item" {...props} />,
        
        // 标题组件
        h1: ({ ...props }: MarkdownComponentProps) => <h1 className="markdown-heading markdown-h1" {...props} />,
        h2: ({ ...props }: MarkdownComponentProps) => <h2 className="markdown-heading markdown-h2" {...props} />,
        h3: ({ ...props }: MarkdownComponentProps) => <h3 className="markdown-heading markdown-h3" {...props} />,
        h4: ({ ...props }: MarkdownComponentProps) => <h4 className="markdown-heading markdown-h4" {...props} />,
        h5: ({ ...props }: MarkdownComponentProps) => <h5 className="markdown-heading markdown-h5" {...props} />,
        h6: ({ ...props }: MarkdownComponentProps) => <h6 className="markdown-heading markdown-h6" {...props} />,
        
        // 其他元素
        hr: ({ ...props }: MarkdownComponentProps) => <hr className="markdown-hr" {...props} />,
        img: ({ ...props }: MarkdownComponentProps) => <img className="markdown-img" {...props} />
    };
    ...
    return (
        <div className="message-font">
            <div className="message-title">
                ...
                <span className="text-blue-400 message-title-text">{getMarkdownTitle()}</span>
