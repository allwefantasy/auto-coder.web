...
const RegularContextMessage: React.FC<{ message: MessageProps }> = ({ message }) => {
    return (
        <div className="font-mono text-xs bg-gray-850 rounded-lg overflow-hidden border border-gray-700 shadow-md">
            {/* Header section with gradient background */}            
            <div className="bg-gradient-to-r from-blue-900/70 to-indigo-900/70 px-3 py-2 border-b border-gray-700 flex items-center">
